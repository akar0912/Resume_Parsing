    ...
    for filename in os.listdir(path):
        if filename.endswith(('.pdf')):
            ...
            data.append({"FileName":filename, "FileContents":res, "Name":name, "Email Address":email,"Skills":skills,
                    "Contact Number":cno,"Experience": exp,"python_count":python_count,"excel_count":excel_count,"vba_count":vba_count,"sql_count":sql_count},ignore_index=True)
...
def CreatePDF():
    ...
    path = "C:\\Users\\Lenovo\\Desktop\\Resume\\"
...
class TKGUI:
    ...
    def save_skills(self, event, v1, v2, v3, v4, v5):
        varstates = "Python: %d,\R: %d,R: %d,Qlikview: %d,VBA: %d,Excel: %d" % (v1.get(), v2.get(),v3.get(),v4.get(),v5.get())
        with open("C:\\Users\\Lenovo\\Desktop\\Resume\\output.txt","w") as f:
            f.write(varstates)
        with open("C:\\Users\\Lenovo\\Desktop\\Resume\\output.txt","r") as f:
            print(f.read())
    ...
    def skills(self):
        ...
        Button(self.root, text="Back", command=main_GUI).pack()
    ...
    def main_GUI(self):
        ...
        Button(top_frame,text = "Enter Skills",command = skills).pack()
